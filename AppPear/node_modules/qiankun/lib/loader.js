    ...
    return (0, _tslib.__generator)(this, function (_m) {
      switch (_m.label) {
        case 0:
          ...
          _b = configuration.singular, singular = _b === void 0 ? false : _b, _c = configuration.sandbox, sandbox = _c === void 0 ? true : _c, importEntryOpts = (0, _tslib.__rest)(configuration, ["singular", "sandbox"]);
          return [4
          /*yield*/
        ...
        case 4:
          ...
          _e = (0, _mergeWith2.default)({}, (0, _addons.default)(global, assetPublicPath), lifeCycles, function (v1, v2) {
